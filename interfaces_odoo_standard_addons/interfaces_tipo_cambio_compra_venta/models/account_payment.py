    ...
    def get_tipo_cambio_default(self):
        ...
        if self.currency_id:
            ...
            currency_rate = _get_conversion_rate(
                self.currency_id, self.company_id.currency_id, self.company_id, (self.date or self.invoice_date or fields.date.today())
            )
        if self.currency_rate != currency_rate:
            self.currency_rate = currency_rate

    @api.onchange("date", "currency_id", "currency_rate", "journal_id")
