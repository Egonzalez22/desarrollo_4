odoo.define('pos_invoice.PaymentScreenCustom', function(require){
    const PaymentScreen = require('point_of_sale.PaymentScreen')
    const Registries = require('point_of_sale.Registries')
    const core = require('web.core')
    const _t = core._t
    //addons/point_of_sale/static/src/js/Screens/PaymentScreen/PaymentScreen.js
    //line 191
                ...
                try {
                    ...
                    if (this.currentOrder.is_to_invoice()) {
                        if (syncOrderResult.length) {
                            ...
                            // facturacion_electronica_py.factura_report_action
